<template>
  <div class="talkshow-show">
    <!-- 热门脱口秀 -->
    <div class="hot-shows">
      <div class="section-title">热门脱口秀</div>
      <div class="show-list">
    ...
    <div class="coming-shows">
      <div class="section-title">即将开演</div>
      <div class="show-list">
    ...
    <!-- 脱口秀推荐广告 -->
    <div class="talkshow-ad">
      <img src="@/assets/movie.jpg" alt="脱口秀推荐" class="ad-img">
    </div>
